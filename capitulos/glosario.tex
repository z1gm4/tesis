...
%%acrónimo
\newglossaryentry{lbt}{type=\acronymtype, name={Listen Before Talk}, description={\textit{Listen Before Talk}},  first={LBT(\textit{Listen Before Talk})\glsadd{lbtg}}, see=[Glosario:]{lbtg}}
