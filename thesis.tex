...
En resumen, el producto resultante de esta memoria de título ha sido un modelo de simulación de dispositivos LoRa y un módulo de transición entre \gls{lorawan}/IPv6. En relación al modelo de simulación, este minimizará y ayudará con actividades como el diseño y verificación del comportamiento de estos dispositivos. Por otra parte el módulo de transición otorga la capacidad de integrar el \gls{iot} en estos dispositivos, mediante el uso de sockets.}
...
\justify
\input{capitulos/fundamentosteoricosymetodos}
\justify
\input{capitulos/resultados}
\justify
\input{capitulos/concluyanalisis}
...
%asd
\input{capitulos/anexoa}
%asd
\input{capitulos/anexob}
\input{capitulos/anexoc}
